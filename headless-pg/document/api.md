...
```
curl -H "Authorization: your-key" "http://localhost:3000/api/data/list?content=test2&order=desc"
```
...
```
curl -H "Authorization: your-key" http://localhost:3000/api/data/getone?id=3
```
